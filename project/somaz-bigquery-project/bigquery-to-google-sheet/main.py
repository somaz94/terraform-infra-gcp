...
def bigquery_to_sheets(request):
    try:
        ...
        dataset_id = os.environ.get('BIGQUERY_DATASET', 'somaz-bigquery-project.mongodb_dataset') # <project>.<dataset>
        ...
        sh = gc.open_by_key('115whdsfsdxRBsfsdafs8jS5S3NN1wFaascvzdasfsaXvB_M')
